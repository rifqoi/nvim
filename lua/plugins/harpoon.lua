...
nnoremap("<leader>b", ":lua require('harpoon.ui').nav_file(1)<CR>", "silent")
nnoremap("<leader>n", ":lua require('harpoon.ui').nav_file(2)<CR>", "silent")
nnoremap("<leader>m", ":lua require('harpoon.ui').nav_file(3)<CR>", "silent")
nnoremap("<leader>,", ":lua require('harpoon.ui').nav_file(4)<CR>", "silent")
